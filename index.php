    ...
    <body>
        ...
        <div id="glavni">
            <form action="igra.php" name="forma" method="post">
                <div id="igrac">               
                    <div class="igralec">IGRALEC 1<br /><br />  <input type="text" name="ime1"  autofocus/></div>
                    <div class="igralec">IGRALEC 2<br /><br />  <input type="text" name="ime2"  autofocus/></div>
                    <div class="igralec">IGRALEC 3<br /><br />  <input type="text" name="ime3"  autofocus/></div>
                </div>
